<template>
  ...
  <div v-else>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px">
      <div>
        <div class="font-bold mb-8"><i class="fa-brands fa-dropbox"></i> {{ t.report.npm.stats }}</div>
      ...
      <div>
        <div class="font-bold mb-8"><i class="fa-solid fa-layer-group"></i> {{ t.report.npm.recommended }}</div>
    ...
    <div class="font-bold mb-8"><i class="fa-solid fa-building"></i> {{ t.report.npm.sapPkgsList }}</div>
