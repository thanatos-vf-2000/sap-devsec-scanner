...
| `GET` | `/api/sap/ui5/resources/:version` | Retrieving version details |
...
### `/api/scan/history` History Example
...
### `/api/sap/ui5/version` ui5 version Example
...
### `/api/sap/ui5/resources/:version` Ressource version x.xx.x Example
